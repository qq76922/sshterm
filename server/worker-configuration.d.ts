/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc server/worker-configuration.d.ts` (hash: fe41e1589c1831e446559b34928dec54)
// Runtime types generated with workerd@1.20260701.1 2026-01-01 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	SSH_SESSION: DurableObjectNamespace<import("./src/index").SshSession>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SshSession";
	}
